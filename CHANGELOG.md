...
- In HTTP-related detection event structures, the `referer` field has been
  renamed to `referrer`, as these are not direct representations of the HTTP
  protocol and should use the correct spelling outside protocol-specific
  contexts.
