...
pub type BlocklistHttpFields = BlocklistHttpFieldsV0_43;

#[derive(Debug, Deserialize, Serialize)]
pub struct BlocklistHttpFieldsV0_43 {
    pub sensor: String,
    pub src_addr: IpAddr,
    pub src_port: u16,
    pub dst_addr: IpAddr,
...
#[derive(Debug, Deserialize, Serialize)]
pub(crate) struct BlocklistHttpFieldsV0_42 {
    pub sensor: String,
    pub src_addr: IpAddr,
    pub src_port: u16,
    pub dst_addr: IpAddr,
...
impl From<BlocklistHttpFieldsV0_41> for BlocklistHttpFieldsV0_42 {
